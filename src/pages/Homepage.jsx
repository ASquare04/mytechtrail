...
const Homepage = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="relative md:mt-20 flex flex-col items-center h-96 justify-center">
        ...
        <img
          ...
          alt="Python"
          className="w-10 h-10 md:w-20 md:h-24 hidden md:block icon absolute top-5 left-12 rotate-12 hover:cursor-pointer"
        />
        <img
          ref={(el) => (iconsRef.current[1] = el)}
          src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg"
          alt="Java"
          className="w-10 h-10 md:w-20 md:h-24 hidden md:block icon absolute top-5 right-12 -rotate-12"
        />
        <img
          ref={(el) => (iconsRef.current[2] = el)}
          src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg"
          alt="HTML5"
          className="w-10 h-10 md:w-20 md:h-24 hidden md:block icon absolute bottom-10 left-24 rotate-12"
        />
        <img
          ref={(el) => (iconsRef.current[3] = el)}
          src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg"
          alt="CSS3"
          className="w-10 h-10 md:w-20 md:h-24 hidden md:block icon absolute bottom-10 right-24 -rotate-12"
        />
        <img
